        ...
        <div class="fab-reports-container">
            ...
            foreach ($settings as $k => $v) {
                if(($v->type == 'video' && in_array('HAS_VIDEO', Yii::app()->params['features'])) ||
                   ...
                   ($v->type != 'video' && $v->type != 'ticker' && $v->type != 'game' && $v->type != 'report'
                   && $v->attribute != 'graph_videos' && $v->attribute != 'graph_tickers'
                   && $v->attribute != 'graph_votes' && $v->attribute != 'graph_images'
                   && $v->attribute != 'map_show_vote_count' && $v->attribute != 'map_show_video_count'
                   && $v->attribute != 'map_show_income')) {
            ...
            foreach ($categorizedSettings as $k => $v) {
                ...
                $rows = '';
                foreach ($v as $kk => $vv) {//var_dump($kk);
