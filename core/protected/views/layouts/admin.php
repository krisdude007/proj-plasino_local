        ...
        <div class="fab-page-container fab-row-fluid">
            ...
            <div class="fab-nav-collapse fab-collapse" style="position:absolute;">
                <ul id="adminNav">
                    ...
                    <?php endif; ?>
                    <?php if (in_array('HAS_AFFIDAVIT_CONTROL', Yii::app()->params['features']) && (Yii::app()->user->isSuperAdmin() || Yii::app()->user->isSiteAdmin() || Yii::app()->user->hasPermission('adminaffidavit'))): ?>
                        <li <?php echo (Yii::app()->controller->id == 'adminAffidavit') ? 'class="on"' : ''; ?>>
                            <a href="/admin/affidavit">
                                <div style="background-image:url('/core/webassets/images/adminnav/voting-transparent.png');">
                                    <span>Affidavit Admin</span>
                                </div>
                            </a>
                        </li>
                    <?php endif; ?>
