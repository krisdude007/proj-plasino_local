 ...
 */
class BizTalkAffiliate extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('user_id, market_name, contact_email, contact_phone_no, radio_dma, call_letters, city_of_license, state_of_license, created_on, updated_on', 'required'),
			array('user_id, contact_phone_no', 'numerical', 'integerOnly'=>true),
			array('contact, contact_phone_no', 'length', 'max'=>20),
                        array('contact_emails, radio_dma, call_letters', 'length', 'max'=>255),
			array('license_market_rank', 'length', 'max'=>10),
			array('market_name, city_of_license, radio_dma, call_letters, state_of_license, fm_frequency, am_frequency', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, contact, contact_email, contact_phone_no, radio_dma, license_market_rank, market_name, call_letters, city_of_license, state_of_license, fm_frequency, am_frequency, created_on, updated_on', 'safe', 'on'=>'search'),
		);
	}
