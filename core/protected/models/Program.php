 ...
 * @property integer $aired
 * @property string $air_time
 * @property string $aired_day
 * @property string $aired_month
...
class Program extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, program_name, aired_day, aired_month', 'required'),
			array('user_id, aired', 'numerical', 'integerOnly'=>true),
	...
	public function search()
	{
		...
		$criteria->compare('aired',$this->aired);
		$criteria->compare('air_time',$this->air_time,true);
		$criteria->compare('aired_day',$this->aired_day,true);
		$criteria->compare('aired_month',$this->aired_month,true);
