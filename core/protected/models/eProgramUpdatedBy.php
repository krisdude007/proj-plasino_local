 ...
 */
class eProgramUpdatedBy extends ProgramUpdatedBy
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('updated_month', 'length', 'max'=>255),
                        ...
                        array('is_updated', 'numerical', 'integerOnly' => true),
                        array('is_updated', 'required', 'requiredValue' => 1, 'on' => 'affidavit', 'message'=>Yii::t('youtoo','Confirmed to save changes.')),
