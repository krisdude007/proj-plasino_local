...
<div class='as-table'>
    ...
    <div style='position: relative;'>
        <a onclick="window.location = '<?php echo $url; ?>'"><img src="/webassets/mobile/images/image_background_mobile_viernes-futbolero.png" style="width: 100%;"/></a>
    </div>
    <div class="homeFooter text-center as-table-row">
        <div style="background-color: #2a3335; position: relative;padding-left: 0px; padding-right: 0px;">
        ...
        <div style="background-color: #040b02; position: relative; padding: 20px; margin: 10px;">
            <h3 style="text-align: left; color: #40ed67;font-weight: 300;">Juego</h3>
        ...
        <div style="background-color: #040b02; position: relative; padding: 20px; margin: 10px;">
            <h3 style="text-align: left; color: #40ed67;font-weight: 300;">Cómo participar</h3>
        ...
        <div style="background-color: #040b02; position: relative; padding: 20px; margin: 10px;">
            <h3 style="text-align: left; color: #40ed67;font-weight: 300;">Lista de Premios</h3>
        ...
        <div style="background-color: #040b02; position: relative; padding: 20px;margin: 10px;">
            <h3 style="text-align: left; color: #40ed67;font-weight: 300;">Selección del Ganador</h3>
