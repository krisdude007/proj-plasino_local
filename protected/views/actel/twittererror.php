    ...
    <div class="subContainer">
        <div class="row">
            <div class="col-xs-8 col-xs-offset-2">
                <h1><?php echo Yii::t('youtoo','You did not pay. Please Authorize your payment.')?></h1>
                <p class="lead" style="font-weight: bold;">
                    <?php echo Yii::t('youtoo',"Play again to increase your chances to win");?>
                </p>
                <p>
                    <?php $credit= '10 Dollars'; echo Yii::t('youtoo',"Thank you for answering. Unfortunately, We were unable to charge 5 Dollars. Please go to your account and verify your charge. ",array());?>
                </p>
<!--                <p>
...
<!--                            <h5><?php echo Yii::t('youtoo','Payment method: WEB')?></h5>-->
                        ...
                        <td style='width:50%;background-color: #ffffff;padding: 12px;'>
                            <div style='overflow:hidden;'>
                                <h4 style='display: inline;'><?php echo Yii::t('youtoo','Credits earned')?>:</h4> <h5 style='display: inline;'><?php $credit=0; echo $credit ?> <?php echo Yii::t('youtoo','Credits')?></h5>
                            </div>
                            <br/>
                            ...
                            <hr style='margin: 2px 0px;'>
                            <div style='overflow:hidden;'>
                                <h4 style='float:left;width: 65%;'>(1)<?php echo Yii::t('youtoo','Participation fee: Equivalent to USD')?></h4><h4 style='float:left;'> <?php $price = 5; echo $price ?> USD</h4>
                            </div>
                            <hr style='margin: 2px 0px;'>
                            <div style='overflow:hidden;'>
                                <h4 style='float:left;width: 10%;'></h4><h4 style='float:left;'><?php echo Yii::t('youtoo','Total')?>: <?php $price = 5; echo $price ?> USD</h4>
                            </div>
                        </td>
                        </tr>
                    </table>
