    ...
    <div class="subContainer">
        <div class="row">
            <div class="col-xs-8 col-xs-offset-2">
                <h1><?php echo Yii::t('youtoo','Correct Answer')?></h1>
                ...
                <p>
                    <table style="width: 100%;border: 1px solid #cdcdcd;text-align: left;">
                        ...
                        <td style='width:50%;background-color: #ffffff;padding: 12px; color: #171717;'>
                            ...
                            <hr style='margin: 2px 0px;'>
                            <div style='overflow:hidden;'>
                                <h4 style='float:left;width: 65%;'><?php echo Yii::t('youtoo','Game fee:')?></h4><h4 style='float:left;'> $<?php $price = isset($game->price) ? $game->price : 1 ; echo $price ?>.00</h4>
                            </div>
                            <hr style='margin: 2px 0px;'>
                            <div style='overflow:hidden;'>
                                <h4 style='float:left;width: 65%;'><?php echo Yii::t('youtoo','Total:')?></h4><h4 style='float:left;'> $<?php $price = isset($game->price) ? $game->price : 1 ; echo $price ?>.00</h4>
                            </div>
                        </td>
                        </tr>
                    </table>
