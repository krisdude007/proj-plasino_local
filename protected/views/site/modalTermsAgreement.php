<!-- ModalTerms -->
<div class="modal fade" id="modalTermsAgreement" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title" style='color:#000000' id="myModalLabel"><?php echo Yii::t('youtoo', 'Agree to Terms') ?></h4>
            </div>
            <div class="modal-body" style='color:#000000'>
                ...
                <div class="scroll-terms">
					...
					<p>
						<strong>14. Self-Exclusion:</strong>
				...
				<span class="margin-30-30" style="text-align:center;"> 
					<input id="checkBox" type="checkbox"><strong>Yes,  I have read, and agree to these terms of service.</strong>
			   </span>
			   
			  	<input class="btn btn-default" role="button" style="width: 100%" type="submit" name="" value="submit">
				<p>
				<hr class="margin-30-30">
					<strong>Questions: </strong>Please contact
					<a href="mailto:support@isweepsusa.com">support@isweepsusa.com</a> if you have any questions regarding the Sweepstakes.
				</p>
