...
echo "<div style='background: transparent; color: #ffffff; max-width: 200px; margin: 0 auto; text-align: left; padding-top: 10px; padding-bottom: 7px; line-height: 2.5; font-size: 17px; font-weight: bold;'>";
echo "<a href='".Yii::app()->createUrl('/playnow')."'><img src='/webassets/images/newbground_2.png' style='max-width: 100%'/></a>";

//echo  strpos($_SERVER["HTTP_USER_AGENT"], 'Firefox') ? "<a href='".Yii::app()->createUrl('/playnow')."' onclick='isChecked(); return false;' id='game_redirect' class='btn btn-default btn-lg active' style='margin: 9px;'>Submit Answer</a>" : "<a href='".Yii::app()->createUrl('/playnow')."' onclick='isChecked(); return false;' id='game_redirect' class='btn btn-default btn-lg active'>Submit Answer</a>";
echo "</div>";
